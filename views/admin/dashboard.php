...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="../../public/web/images/2.png">
                <span class="username">
					<?php
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="<?php echo URL;?>admin\addSlide">Thêm Slide</a></li>
                        <li><a href="<?php echo URL;?>admin\allSlide">Liệt kê Slide</a></li>	
                    </ul>
				</li>
				<!-- <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-tasks"></i>
                        <span>Danh mục sản phẩm bánh</span>
                    </a>
                    <ul class="sub">
                        <li><a href="add-category-product-cake">Thêm danh mục sản phẩm bánh</a></li>
                        <li><a href="all-category-product-cake">Liệt kê danh mục sản phẩm bánh</a></li>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="add-shop-product-cake">Thêm danh mục bánh</a></li>
                        <li><a href="#">Liệt kê danh mục bánh</a></li>
